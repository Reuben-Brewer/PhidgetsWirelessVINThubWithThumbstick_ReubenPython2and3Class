...
if __name__ == '__main__':
    ...
    #################################################
    global SHOW_IN_GUI_WiFiVINTthumbstick_FLAG
    SHOW_IN_GUI_WiFiVINTthumbstick_FLAG = 1
    ...
    PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3ClassObject_GUIparametersDict = dict([("USE_GUI_FLAG", USE_GUI_FLAG and SHOW_IN_GUI_WiFiVINTthumbstick_FLAG),
                                    ("root", Tab_WiFiVINTthumbstick), #root Tab_WiFiVINTthumbstick
    ...
    if USE_WiFiVINTthumbstick_FLAG == 1:
        try:
            ...
            print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3ClassObject __init__: Exceptions: %s" % exceptions, 0)
            traceback.print_exc()
    #################################################
    #################################################
    ...
    if USE_WiFiVINTthumbstick_FLAG == 1 and WiFiVINTthumbstick_OPEN_FLAG != 1:
        print("Failed to open PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class.")
