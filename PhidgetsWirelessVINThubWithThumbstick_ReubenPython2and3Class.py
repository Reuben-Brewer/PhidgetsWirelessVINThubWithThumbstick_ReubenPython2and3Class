...
class PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class(Frame): #Subclass the Tkinter Frame
    ...
    def __init__(self, setup_dict): #Subclass the Tkinter Frame
        ...
        self.StartingTime_CTimestampFromVoltageRatioInput0DataCallback = -11111.0
        ...
        self.StartingTime_TimestampFromVoltageRatioInput1DataCallback = -11111.0
        ...
        self.StartingTime_TimestampFromDigitalInput0DataCallback = -11111.0
        ...
        self.MostRecentDataDict_NeedsToBeChangedFlag = 1
        ...
        if "GUIparametersDict" in setup_dict:
            ...
            print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class __init__: RootIsOwnedExternallyFlag: " + str(self.RootIsOwnedExternallyFlag))
            ##########################################
            ...
            print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class __init__: GUI_RootAfterCallbackInterval_Milliseconds: " + str(self.GUI_RootAfterCallbackInterval_Milliseconds))
            ##########################################
        ...
        if "VINT_DesiredSerialNumber" in setup_dict:
            ...
            print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class __init__: ERROR, must initialize object with 'VINT_DesiredSerialNumber' argument.")
        ...
        if "VoltageRatioInput0Object_LowPassFilter_Lambda" in setup_dict:
            ...
            self.VoltageRatioInput0Object_LowPassFilter_Lambda = 0.0 #No filter
        ...
        if "VoltageRatioInput1Object_LowPassFilter_Lambda" in setup_dict:
            ...
            self.VoltageRatioInput1Object_LowPassFilter_Lambda = 0.0 #No filter
        ...
        try:
            Net.addServer(self.WirelessVINThub_ServerName_Str,
                          ...
                          self.WirelessVINThub_Flags_Int)  # addServer(serverName, address, port, password, flags)
        ...
        try:
            ...
            #Net.setOnServerAddedHandler(self.Phidgets_ServerAdded_EventHandler)
            #Net.setOnServerRemovedHandler(self.Phidgets_ServerRemoved_EventHandler)
        ...
        if self.PhidgetsDeviceConnectedFlag == 1:
            ...
            if self.UsePhidgetsLoggingInternalToThisClassObjectFlag == 1:
                try:
                    ...
                    print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class __init__Enabled Phidget Logging.")
                except PhidgetException as e:
                    print("PhidgetsWirelessVINThubWithThumbstick_ReubenPython2and3Class __init__Failed to enable Phidget Logging, Phidget Exception %i: %s" % (e.code, e.details))
            #########################################################
    ...
    def Phidgets_VoltageRatioInput0Object_Attach_EventHandler(self, HandlerSelf):
        ...
        try:
            self.CurrentTime_TimestampForEventFiring_VoltageRatioInput0Object_Attach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampForEventFiring_VoltageRatioInput0Object_Attach
    ...
    def Phidgets_VoltageRatioInput0Object_Detach_EventHandler(self, HandlerSelf):
        ...
        self.CurrentTime_TimestampForEventFiring_VoltageRatioInput0Object_Detach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampForEventFiring_VoltageRatioInput0Object_Detach
    ...
    def Phidgets_VoltageRatioInput0Object_VoltageRatioChange_EventHandler(self, HandlerSelf, VoltageRatio):
        ...
        self.CurrentTime_TimestampFromVoltageRatioInput0DataCallback = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampFromVoltageRatioInput0DataCallback
    ...
    def Phidgets_VoltageRatioInput1Object_Attach_EventHandler(self, HandlerSelf):
        ...
        try:
            self.CurrentTime_TimestampForEventFiring_VoltageRatioInput1Object_Attach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_VoltageRatioInput1Object_Attach
    ...
    def Phidgets_VoltageRatioInput1Object_Detach_EventHandler(self, HandlerSelf):
        ...
        self.CurrentTime_TimestampForEventFiring_VoltageRatioInput1Object_Detach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampForEventFiring_VoltageRatioInput1Object_Detach
    ...
    def Phidgets_VoltageRatioInput1Object_VoltageRatioChange_EventHandler(self, HandlerSelf, VoltageRatio):
        ...
        self.CurrentTime_TimestampFromVoltageRatioInput1DataCallback = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampFromVoltageRatioInput1DataCallback
    ...
    def Phidgets_DigitalInput0Object_Attach_EventHandler(self, HandlerSelf):
        ...
        try:
            self.CurrentTime_TimestampForEventFiring_DigitalInput0Object_Attach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampForEventFiring_DigitalInput0Object_Attach
    ...
    def Phidgets_DigitalInput0Object_Detach_EventHandler(self, HandlerSelf):
        ...
        self.CurrentTime_TimestampForEventFiring_DigitalInput0Object_Detach = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampForEventFiring_DigitalInput0Object_Detach
    ...
    def Phidgets_DigitalInput0Object_StateChange_EventHandler(self, HandlerSelf, State):
        ...
        self.CurrentTime_TimestampFromDigitalInput0DataCallback = self.getPreciseSecondsTimeStampString() #- self.StartingTime_TimestampFromDigitalInput0DataCallback
    ...
    def MainThread(self):
        ...
        while self.EXIT_PROGRAM_FLAG == 0:
            ...
            #########################################################
            if self.MostRecentDataDict_NeedsToBeChangedFlag == 1:
                self.MostRecentDataDict = dict([("VoltageRatioInput0Object_VoltageRatio", self.VoltageRatioInput0Object_VoltageRatio),
                                                ("VoltageRatioInput1Object_VoltageRatio", self.VoltageRatioInput1Object_VoltageRatio),
                                                ("DigitalInput0Object_State", self.DigitalInput0Object_State),
                                                ("DataStreamingFrequency_CalculatedFromMainThread", self.DataStreamingFrequency_CalculatedFromMainThread),
                ...
                self.MostRecentDataDict_NeedsToBeChangedFlag = 0
    ...
    def GUI_Thread(self, parent=None):
        ...
        #################################################
        self.DeviceInfoLabel = Label(self.myFrame, text="Device Info", width=50) #, font=("Helvetica", 16)
        ...
        #################################################
        self.DataDisplayLabel = Label(self.myFrame, text="DataDisplayLabel", width=100)
        ...
        if self.EnableInternal_MyPrint_Flag == 1:
            self.PrintToGui_Label.grid(row=1, column=1, padx=1, pady=1, columnspan=3, rowspan=10)
        ########################
